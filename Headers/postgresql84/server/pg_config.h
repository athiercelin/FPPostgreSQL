...
#define PG_VERSION_STR "PostgreSQL 8.4.0 on i386-apple-darwin10.0.0b2, compiled by GCC i686-apple-darwin10-gcc-4.2.1 (GCC) 4.2.1 (Apple Inc. build 5646), 64-bit"
